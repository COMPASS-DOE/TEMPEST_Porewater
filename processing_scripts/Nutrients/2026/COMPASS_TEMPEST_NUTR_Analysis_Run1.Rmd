...
#identify the files you want to read in 
  #read in as a list to accomadate multiple runs in a month
NH3_PO4_files<- c("Raw Data/20260824_TMP2026_NP_Run1.csv")
  NOx_files    <- c("Raw Data/20260824_TMP2026_VNOx_Run1.csv")

# Define the file path for QAQC log file - NO Need to change just check year 
  file_path <- "Raw Data/SEAL_TEMPEST_QAQC_Log_2026.csv"
...
#record any notes about the run or anything other info here: 
  run_notes <- "NOx Reduction Efficiency Not Done" 
  
#Set up file path for metadata 
  #downloaded metadata csv - downloaded from Google drive as csv for this year
  Raw_Metadata = "TEMPEST_PorewaterInventory_May2022_Present.csv"
...
raw_metadata_lys_combined <- raw_metadata_lys_combined %>%
  dplyr::select("Sample_ID", "Project", "Zone", "Source" ,"Grid", "Depth", "Analyte", "Collection_Date", "Evacuation_date_YYYYMMDD", "Event_Time", "Time_of_day", "Volume_mL", "Notes")
