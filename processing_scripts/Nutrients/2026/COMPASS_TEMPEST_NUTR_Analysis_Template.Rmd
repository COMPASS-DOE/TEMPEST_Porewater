...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_Processed_Run1_2.csv"
...
##link directory to google drive folder
...
raw_metadata_lys_event <- raw_metadata_lys_year %>%  
  filter(str_detect(Sample_ID, "AM|PM"))
...
raw_metadata_lys_event <- raw_metadata_lys_event %>%
  separate(
    col = Sample_ID,
    sep = "_",
    into = c("Project", "Zone", "Source" ,"Grid", "Depth", "Analyte", "Collection_Date", "Timepoint"),
    remove = FALSE)
...
raw_metadata_lys_monmon <- raw_metadata_lys_monmon1 %>%
  separate(
    col = Sample_ID,
    sep = "_",
    into = c("Project", "Zone", "Source" ,"Grid", "Depth", "Analyte", "Collection_Date", "Timepoint"), #Warning is okay
    remove = FALSE)
...
raw_metadata_lys_combined <- raw_metadata_lys_combined %>%
  dplyr::select("Sample_ID", "Project", "Zone", "Source" ,"Grid", "Depth", "Analyte", "Collection_Date", "Evacuation_date_YYYYMMDD", "Timepoint", "Volume_mL", "Notes")
...
raw_metadata_sw_sw <- raw_metadata_sw_sw %>%
  separate(
    col = Sample_ID,
    sep = "_",
    into = c("Project", "Zone", "Source", "Analyte", "Collection_Date", "Timepoint"),
    remove = FALSE)
...
raw_metadata_sw_combined <- raw_metadata_sw_combined %>%
  dplyr::select("Sample_ID", "Project", "Zone", "Source" , "Analyte", "Collection_Date", "Timepoint", "Volume_mL", "Notes")
