...
#read in data 
file1 <- read.csv("Raw Data/SEAL_COMPASS_NH3_PO4_TEMPEST_2023_run1.csv")
...
#read in data 
file2 <- read.csv("Raw Data/SEAL_COMPASS_NH3_PO4_TEMPEST_2023_run2.csv")
#Quick look at dataframe
head(file2)
#take out only the columns that we need 
...
#read in data 
file3 <- read.csv("Raw Data/SEAL_COMPASS_NH3_PO4_TEMPEST_2023_run3.csv")
#Quick look at dataframe
head(file3)
#take out only the columns that we need 
...
#read in data 
Nfile1 <- read.csv("Raw Data/SEAL_COMPASS_VNOx_TEMPEST_2023_run1.csv")
#Quick look at dataframe
head(Nfile1)
#take out only the columns that we need 
...
#read in data 
Nfile2 <- read.csv("Raw Data/SEAL_COMPASS_VNOx_TEMPEST_2023_run2.csv")
#Quick look at dataframe
head(Nfile2)
#take out only the columns that we need 
...
#read in data 
Nfile3 <- read.csv("Raw Data/SEAL_COMPASS_VNOx_TEMPEST_2023_run3.csv")
#Quick look at dataframe
head(Nfile3)
#take out only the columns that we need 
...
##Fix sample IDs
all_data$Sample_Name <- gsub("TEMPEST_C_I5_20230828", "TEMPEST_C_I5_20230628", all_data$Sample_Name)
...
#Export Data
# write.csv(alldat, file="Processed Data/COMPASS_TEMPEST_SEAL_NUTR_2023_postevent.csv")
