...
Nutr_metadata <- Nutr_metadata %>% 
  dplyr::select(-c("Plot", "Project", "Zone", "Source", "Grid", "Collection_Date", "Time_of_day", "Event_Time"))
...
final_data <- merged_data %>%
  ...
  dplyr::select(
         ...
         Deployment_Date, Deployment_Time_24hrs, Collection_Time_24hrs, Sample_ID, 
