...
#Plot Duplicates
Dup_Plot <-  ggplot(Dup_plot_df, aes(x = Short_Names, y = Duplicate_Diff, fill =  Dup_Flag, color = Within_Range)) +
  geom_bar(stat = 'identity',
  ...
  xlab(NULL) +
   labs(title = "Duplicate Check") + scale_x_discrete(guide = ggplot2::guide_axis(n.dodge = 2))
...
Spike_Plot <-  ggplot(Spike_plot_df, aes(x = Short_Names, y = Spike_Diff, fill =  Spike_Flag)) +
  geom_bar(stat = 'identity',
    position = position_dodge2(preserve = "single"), linewidth = 0.75) +
...
Spike_Plot <-  ggplot(Spike_plot_df, aes(x = Sample_Name, y = Spike_Diff, fill =  Spike_Flag)) +
  geom_bar(stat = 'identity',
    position = position_dodge2(preserve = "single"), linewidth = 0.75) +
