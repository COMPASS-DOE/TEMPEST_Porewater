...
folder_2024 <- "~/GitHub/TEMPEST_Porewater/processing_scripts/DOC/tmp_doc_2024/tmp_doc_processed_data_2024/"
...
write_csv(clean_2024, paste0(folder_2024, "01_TMP_PW_NPOCTDN_2024_L1_updated.csv") )#note this is currently set up so that it writes into the folder youre pulling data from so if you run script more than once it will pull in the old file.
