...
#anything that needs to be changed do this in the first chunk
  ...
  run_notes = "Check standards started going out of range after the samples were run. 
              Looked like the flow of the instrument was disrupted, but this was after the 
              samples ran, so I think it is okay to use these data."
  
  #file path and name for summary file 
    raw_file_name = "tmp_doc_raw_data_2026/TMP_202603.txt" 
  #file path and name for the all peaks file 
    raw_allpeaks_name = "tmp_doc_raw_data_2026/TMP_202603_allpeaks.txt"
  #file path and name for processed data after QAQC
    processed_file_name = "tmp_doc_processed_data_2026/TMP_PW_DOC_Processed_202603.csv"
...
final_data <- final_data %>%
 ...
 mutate(Vial_ID = gsub("_DOC", "_15_DOC", Vial_ID))
