...
#anything that needs to be changed do this in the first chunk
  ...
  #file path and name for summary file 
    raw_file_name = "tmp_doc_raw_data_2026/TMP_202605.txt" 
  #file path and name for the all peaks file 
    raw_allpeaks_name = "tmp_doc_raw_data_2026/TMP_202605_allpeaks.txt"
  #file path and name for processed data after QAQC
    processed_file_name = "tmp_doc_processed_data_2026/TMP_PW_DOC_Processed_202605.csv"
...
## Assess Duplicates - no duplicates on this run  
...
colnames(IDs) <- c("Site_Code" ,"Plot", "Grid_Square", "Depth_cm", "Date")
#head(IDs)
