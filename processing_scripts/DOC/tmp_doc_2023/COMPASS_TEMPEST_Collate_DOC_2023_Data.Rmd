...
##Lysimeter data
lys_data <- read.csv(here("DOC/TEMPORARY/", "TMP_PW_GRIDSONLY_NPOCTDN_2023_L1.csv"))
...
##SourceWater data
sw_data <- read.csv(here("DOC/TEMPORARY/", "TMP_SOURCE_NPOCTDN_2023_L1.csv"))
...
all_data <- all_data %>% 
  mutate(Time_of_day = case_when(
    str_detect(sample_name, "_0800") ~ "AM", 
    str_detect(sample_name, "_1600") ~ "PM",
    TRUE ~ NA))
...
final_data <- merged_data %>%
 ...
 select(
    ...
    Run_notes, Field_notes, Evacuation_date_YYYYMMDD, Collection_Date_YYYYMMDD, 
