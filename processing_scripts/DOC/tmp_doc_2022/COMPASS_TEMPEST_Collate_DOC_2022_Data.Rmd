...
```{r pull in non-event metadata for later, include=FALSE}
...
merged_data$Collection_Start_Time_24hrs <- gsub(":00", "", merged_data$Collection_Start_Time_24hrs)
merged_data$Collection_Start_Time_24hrs <- gsub(":", "", merged_data$Collection_Start_Time_24hrs)
