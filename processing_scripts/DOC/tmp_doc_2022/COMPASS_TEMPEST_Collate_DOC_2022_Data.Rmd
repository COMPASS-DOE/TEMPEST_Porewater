...
all_data <- all_data %>% 
  mutate(Sample_ID = ifelse(Date == "20220518" | Date == "20220520" | Grid == "Source", paste(Site, Plot, Grid, Date, Event_Time, sep = "_"), paste(Site, Plot, Grid, Date, sep = "_")))
...
write.csv(final_data, "COMPASS_TEMPEST_DOC_2022.csv")
