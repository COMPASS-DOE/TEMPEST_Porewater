...
Sdat <- read.table("Raw Data/COMPASS_TEMPEST_20230609_SO4.txt",sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("Raw Data/COMPASS_TEMPEST_20230609_Cl.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
QAspks$SampleVol <-  ifelse(QAspks$Dilution == 1.25, 1500, QAspks$SampleVol)
QAspks$SampleVol <-  ifelse(QAspks$Dilution == 1.1, 1500, QAspks$SampleVol)
QAspks$SampleVol <-  ifelse(QAspks$Dilution == 52.74, 1483, QAspks$SampleVol)
QAspks$SampleVol <-  ifelse(QAspks$Dilution == 1.167, 1500, QAspks$SampleVol)
...
write.csv(alldat, file="Processed Data/COMPASS_TEMPEST_Dionex_ClSo4_Final_20230609.csv")           #Change file name
