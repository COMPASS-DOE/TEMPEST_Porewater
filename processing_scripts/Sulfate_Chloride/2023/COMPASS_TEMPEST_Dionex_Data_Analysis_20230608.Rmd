...
Sdat <- read.table("Raw Data/COMPASS_TEMPEST_20230608_SO4.txt",sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("Raw Data/COMPASS_TEMPEST_20230608_Cl.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
write.csv(alldat, file="Processed Data/COMPASS_TEMPEST_Dionex_ClSo4_Final_20230608.csv")           #Change file name
