...
author: "Apr-Dec (No May or June) 2024 Samples"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: true
...
###### Run information - PLEASE CHANGE
  Sample_Year = "2024"  
  Date_Run = "2025-08-13"  #Date that instrument was run
  Run_by = "Zoe Read"  #Instrument user 
  Script_run_by = "Zoe Read" #Code user 
  run_notes = "Check standard 1 is low for SO4, so <80% of Sulfate Check 
...
Old_ID_1 = "TMP_SW_F6_20241111_15cm"
New_ID_1 = "TMP_SW_F6_20241104_15cm"
  
###### File Names - PLEASE CHANGE 
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/COMPASS_TEMPEST_202404-202412_Cl.txt"
  raw_file_name_so4 = "Raw Data/COMPASS_TEMPEST_202404-202412_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/COMPASS_TEMPEST_Processed_Cl_SO4_202404-202412.csv" 
...
##Sample ran twice, unclear whether it was the correct one, so removed
all_dat <- all_dat %>% 
  filter(sample_ID != "72_TMP_SW_F4_20241213_15cm") %>% 
  filter(sample_ID != "73_TMP_SW_F4_20241213_15cm")
```
