...
###### Run information - PLEASE CHANGE
  Sample_Year = "2026"  
  Date_Run = "2026-08-26"  #Date that instrument was run
...
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/COMPASS_TEMPEST_202606_1-23_Cl.txt"
  raw_file_name_so4 = "Raw Data/COMPASS_TEMPEST_202606_1-23_SO4.txt"
  
#Sample ID Path
  SampleID_path = "Raw Data/TEMPEST_SO4_20260501-20260612_corrected.csv"

#file path and name of processed data file 
  processed_file_name = "Processed Data/COMPASS_TEMPEST_Processed_Cl_SO4_202606_1-23.csv" 
...
##Remove samples after 23, only ran 1-23 before sampler needle got stuck
all_dat <- all_dat %>%
  slice_head(n = 42)
