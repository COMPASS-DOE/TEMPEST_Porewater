...
###### Run information - PLEASE CHANGE
  Sample_Year = "2026"  
  Date_Run = "2026-08-06"  #Date that instrument was run
  Run_by = "Zoe Read"  #Instrument user 
  Script_run_by = "Zoe Read" #Code user 
  run_notes = "1/6 SO4 dups was bad. 
...
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/COMPASS_TEMPEST_202603-05_Cl.txt"
  raw_file_name_so4 = "Raw Data/COMPASS_TEMPEST_202603-05_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/COMPASS_TEMPEST_Processed_Cl_SO4_2020603-05.csv" 
...
raw_metadata_sw_combined <- raw_metadata_sw_combined %>%
  mutate(Cl_SO4_ID = paste(Project,
                          ...
                          Collection_Date, 
                          sep = "_")) %>%
  rename(Collection_End_Time_24hrs = Collection_Time_24hrs)
...
final_data <- final_data %>%
  ...
  select(
    Project, Sample_ID, Zone, Grid, Depth_cm, Event_Time, Time_of_day, 
         Source, Volume_mL, Collection_Date, Evacuation_Date, Collection_Start_Time_24hrs, Collection_End_Time_24hrs, EST_EDT, 
