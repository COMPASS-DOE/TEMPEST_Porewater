...
viz_cl_plot_avgs <- ggplot(Dionex_avg, aes(x = Collection_Date_formatted, y = mean_Cl, color = plot_1)) +
  geom_point(size = 3) + 
...
viz_so4_plot_avgs <- ggplot(Dionex_avg, aes(x = Collection_Date_formatted, y = mean_SO4, color = plot_1)) +
  geom_point(size = 3) + 
