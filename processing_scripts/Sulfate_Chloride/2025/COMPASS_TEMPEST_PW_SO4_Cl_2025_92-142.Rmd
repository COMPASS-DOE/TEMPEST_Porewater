...
###### Run information - PLEASE CHANGE
  Sample_Year = "2025"  
  Date_Run = "2025-12-15"  #Date that instrument was run
  Run_by = "Zoe Read"  #Instrument user 
  Script_run_by = "Zoe Read" #Code user 
  run_notes = "Some sample IDs are missing from metadata: TMP_SW_H6_20250926_15CM. 
  One bad dup and one bad spk. 
...
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/COMPASS_TEMPEST_2025_92-142_and_FATE_Cl.txt"
  raw_file_name_so4 = "Raw Data/COMPASS_TEMPEST_2025_92-142_and_FATE_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/COMPASS_TEMPEST_Processed_Cl_SO4_2025_92-142.csv" 
