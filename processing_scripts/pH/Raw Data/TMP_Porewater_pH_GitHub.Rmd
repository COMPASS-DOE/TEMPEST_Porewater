...
drive_download(file = inventory_directory, path = "Data from Google Drive/TEMPEST_PorewaterInventory_May2022_Present.xlsx", overwrite = TRUE)

sheet_names <- excel_sheets("Data from Google Drive/TEMPEST_PorewaterInventory_May2022_Present.xlsx")
sheet_names

sample_key <- readxl::read_excel("Data from Google Drive/TEMPEST_PorewaterInventory_May2022_Present.xlsx", sheet = "Porewater - Individual", skip = 3) %>%
...
drive_download(file = directory, path = "Data from Google Drive/TEMPEST_Porewater_pH.xlsx", overwrite = TRUE)

sheet_names <- excel_sheets("Data from Google Drive/TEMPEST_Porewater_pH.xlsx")
sheet_names

# pH_raw <- readxl::read_excel("~/GitHub/TEMPEST-1-porewater/data_do_not_commit/porewater_pH_raw.xlsx", sheet="pH") 

pH_raw <- readxl::read_excel("Data from Google Drive/TEMPEST_Porewater_pH.xlsx", sheet="pH") 
...
pH <- pH_raw %>%
  ...
  select(Site, plot, grid, pH, collection_temp_C, datetime, Date_YYYYMMDD, Time_24hr, tz, flag, Notes)
```
