...
pH <- pH_raw %>%
  ...
  select(Site, plot, grid, pH, Cond, Cond_units, collection_temp_C, datetime, Date_YYYYMMDD, Time_24hr, tz, flag, Notes)
```
...
porewater_pH_2023 <- porewater_pH %>% filter(datetime < year2_stop & datetime > year2_start) %>%
  select(Site, plot, grid, pH, collection_temp_C, datetime, Date_YYYYMMDD, Time_24hr, tz, evacuation_date, flag)
...
source_pH_2023 <- pH %>%
  ...
  select(Site, plot, grid, pH, collection_temp_C, datetime, Date_YYYYMMDD, Time_24hr, tz, flag)
