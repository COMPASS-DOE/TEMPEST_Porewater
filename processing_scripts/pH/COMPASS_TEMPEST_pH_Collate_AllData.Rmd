...
all_dat <- raw_dat %>%
  ...
  select(Project, Sample_ID, Year, Month, Day, Zone, Grid, pH, collection_temp_C, tz, Date_YYYYMMDD, Time_24hr, Evacuation_Date, temperature_flag, temperature_flag, pH_flag) 
