...
raw_dat <- raw_dat %>% 
  mutate(Grid = ifelse(str_detect(Sample_ID, "SOURCE"), "Sourcewater", Grid)) ##Why does 2024 sourcewater data not have attached metadata? 
...
viz_cl_plot <- ggplot(data_plotting, aes(x = as.character(Year), y = Cl_ppm, fill = plot_1)) +
...
viz_so4_plot <- ggplot(data_plotting, aes(x = as.character(Year), y = SO4_ppm, fill = plot_1)) +
  geom_bar(stat = "identity", position = position_dodge2(preserve = "total")) +
  facet_wrap( ~ plot_1, scales="free") +
  scale_fill_manual(values = c(
    "Control" = "springgreen2",
...
viz_cl_plot_avgs <- ggplot(Sulfide_avg, aes(x = Collection_Date_formatted, y = mean_Cl, color = plot_1)) +
  geom_point(size = 3) + 
  ...
  theme_classic() +
  labs(x = "Date", y = "Chloride (ppm)", title = "TEMPEST Porewater: Chloride") +
  theme(
...
viz_so4_plot_avgs <- ggplot(Sulfide_avg, aes(x = Collection_Date_formatted, y = mean_SO4, color = plot_1)) +
  geom_point(size = 3) + 
  ...
  theme_classic() +
  labs(x = "Date", y = "Sulfate (ppm)", title = "TEMPEST Porewater: Sulfate") +
  theme(
    panel.spacing = unit(0.5, "lines"), 
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1)) +
  # theme(axis.text.x = element_text(angle = 90, hjust = 0.5))+ 
...
viz_cl_boxplot <- ggplot(data_plotting, aes(x = Collection_Date,  y = Cl_ppm, fill = plot_1)) +
  geom_boxplot() + 
  facet_wrap( ~ plot_1, scales="free_y", ncol = 1) +
...
viz_so4_boxplot <- ggplot(data_plotting, aes(x = Collection_Date,  y = SO4_ppm, fill = plot_1)) +
  geom_boxplot() + 
  facet_wrap( ~ plot_1, scales="free_y", ncol = 1) +
  scale_x_discrete(drop = TRUE) +
  scale_fill_manual(values = c(
...
viz_cl_boxplot <- ggplot(data_plotting, aes(x = Collection_Date,  y = Cl_ppm, fill = plot_1)) +
  ...
  theme_classic() +
  labs(x = " ", y = "Chloride (ppm)", title = "TEMPEST Sourcewater: Chloride") +
  theme(
    panel.spacing = unit(0.5, "lines"), 
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1)) +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))+ 
...
viz_so4_boxplot <- ggplot(data_plotting, aes(x = Collection_Date,  y = SO4_ppm, fill = plot_1)) +
  ...
  theme_classic() +
  labs(x = " ", y = "Sulfate (ppm)", title = "TEMPEST Sourcewater: Sulfate") +
  theme(
    panel.spacing = unit(0.5, "lines"), 
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1)) +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))+ 
...
##Boxplot Summarize SO4 and Cl by Date, Site, and Zone
viz_cl_boxplot <- ggplot(data_plotting, aes(x = Grid,  y = Cl_ppm, fill = plot_1)) +
  geom_boxplot() + 
  facet_wrap( ~ plot_1, scales="free_y", ncol = 1) +
  scale_x_discrete(drop = TRUE) +
  scale_fill_manual(values = c(
  ...
  theme_classic() +
  labs(x = "Grid ID", y = "Chloride (ppm)", title = "TEMPEST Porewater: Chloride by Grid") +
  theme(
    panel.spacing = unit(0.5, "lines"), 
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1)) +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))+ 
...
viz_so4_boxplot <- ggplot(data_plotting, aes(x = Grid,  y = SO4_ppm, fill = plot_1)) +
  geom_boxplot() + 
  facet_wrap( ~ plot_1, scales="free_y", ncol = 1) +
  scale_x_discrete(drop = TRUE) +
  scale_fill_manual(values = c(
  ...
  theme_classic() +
  labs(x = "Grid ID", y = "Sulfate (ppm)", title = "TEMPEST Porewater: Sulfate by Grid") +
  theme(
    panel.spacing = unit(0.5, "lines"), 
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1)) +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))+ 
...
kable(
  summary_by_year[, c("Year", "plot_1", "min_Cl_ppm",	"max_Cl_ppm",	"mean_Cl_ppm", "min_SO4_ppm",	"max_SO4_ppm",	"mean_SO4_ppm")],  
  format = "latex",
  booktabs = TRUE,
...
kable(
  summary_all_years[, c("plot_1", "min_Cl_ppm",	"max_Cl_ppm",	"mean_Cl_ppm", "min_SO4_ppm",	"max_SO4_ppm",	"mean_SO4_ppm")],  
  format = "latex",
  booktabs = TRUE,
...
kable(
  summary_by_year_source[, c("Year", "plot_1", "min_Cl_ppm",	"max_Cl_ppm",	"mean_Cl_ppm", "min_SO4_ppm",	"max_SO4_ppm",	"mean_SO4_ppm")],  
  format = "latex",
  booktabs = TRUE,
