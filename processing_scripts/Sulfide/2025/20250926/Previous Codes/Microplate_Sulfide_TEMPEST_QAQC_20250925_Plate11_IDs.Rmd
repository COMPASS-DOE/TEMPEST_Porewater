...
###### Run information - PLEASE CHANGE
  ...
  Project = "TEMPEST"
  run_notes = "Std Curve r2 is below cutoff: 0.970815. 
  Std curve intercept is 2 sd different from previous intercepts. 
  Dup & respective sample H2S values were 0. 
  Spk percent recovery was slightly below the cutoff (78.69356 compared to 80 cutoff). 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c("B01") #Ex. c("A02", "B02")
