...
Sample_data$IDs <- NULL

```

##Removed ADL/BDL samples that were later diluted differently
...
ww_ADL<-subset(Sample_data, (Sample_ID %in% ADL$Sample_ID))
...
ww_BDL<-subset(Sample_data, (Sample_ID %in% BDL$Sample_ID))
...
Sample_data$ID_conc <- paste(Sample_data$Sample_ID, Sample_data$H2S_Conc_flag, sep = "_")
